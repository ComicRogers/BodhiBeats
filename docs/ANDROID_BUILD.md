# BodhiBeats Android 构建说明

本文档说明如何把 BodhiBeats 构建为 Android APK/AAB。前置条件：Node.js 18+、JDK 17、Android SDK。
...
```bash
# 假设包名 com.bodhibeats.app (见 capacitor.config.json)
cp android-plugin/InAppLoginPlugin.java android/app/src/main/java/com/BodhiBeats/app/
cp android-plugin/MainActivity.java android/app/src/main/java/com/BodhiBeats/app/  # 覆盖默认 MainActivity
```
