...
const HOST = process.env.HOST || (process.env.MINERADIO_PLATFORM === 'android' ? '127.0.0.1' : '0.0.0.0');
...
const MINERADIO_PLATFORM = process.env.MINERADIO_PLATFORM || 'desktop';
const PATCH_ENABLED = MINERADIO_PLATFORM === 'desktop';
